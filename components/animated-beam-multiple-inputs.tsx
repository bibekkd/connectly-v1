  ...
  ({ className, children }, ref) => {
    return (
      <div
        ref={ref}
        className={cn(
          "z-10 flex items-center justify-center rounded-full border-2 border-border bg-white shadow-[0_0_20px_-12px_rgba(0,0,0,0.8)]",
          "w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12", // Responsive sizing
          className,
        )}
      >
        {children}
...
export default function AnimatedBeamMultipleOutputDemo({
  ...
  return (
    <div
      ...
      ref={containerRef}
    >
      <div className="flex size-full max-w-xs sm:max-w-sm md:max-w-lg flex-row items-stretch justify-between gap-4 sm:gap-6 md:gap-10">
        <div className="flex flex-col justify-center gap-2 sm:gap-3 md:gap-4">
          <Circle ref={div1Ref}>
            <Icons.googleDrive className="w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6" />
          </Circle>
          <Circle ref={div2Ref}>
            <Icons.googleDocs className="w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6" />
          </Circle>
          <Circle ref={div3Ref}>
            <Icons.whatsapp className="w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6" />
          </Circle>
          <Circle ref={div4Ref}>
            <Icons.messenger className="w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6" />
          </Circle>
          <Circle ref={div5Ref}>
            <Icons.notion className="w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6" />
          </Circle>
        </div>
        <div className="flex flex-col justify-center">
          <Circle ref={div6Ref} className="w-10 h-10 sm:w-12 sm:h-12 md:w-16 md:h-16">
            <Icons.openai className="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8" />
          </Circle>
        </div>
        <div className="flex flex-col justify-center">
          <Circle ref={div7Ref}>
