...
export default function Iphone15Pro({
  ...
  return (
    ...
    >
      ...
      {
        //text && <div className="font-bold bg-green flex items-center justify-center">
        //  hii there
        //</div>
      }
      <foreignObject x="21.25" y="19.25" width="389.5" height="843.5">
        <div className="w-full h-full overflow-hidden rounded-[55.75px] bg-white dark:bg-gray-800">{children}</div>
      </foreignObject>
      {
        //videoSrc && (
        //  <foreignObject x="21.25" y="19.25" width="389.5" height="843.5">
